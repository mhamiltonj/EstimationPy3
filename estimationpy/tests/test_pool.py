...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if platform.architecture()[0] == "32bit":
            ...
            self.filePath = os.path.join(dir_path, "..", "modelica", "FmuExamples", "Resources", "FMUs",
                                         "FirstOrder.fmu")
        else:
        ...
        self.csv_inputPath = os.path.join(dir_path, "..", "modelica", "FmuExamples", "Resources", "data",
    ...
    def test_run_model_pool_data_series(self):
        ...
        n_sims = 10
        vector_values = np.linspace(1.0, 5.0, 10)
        values = []
        ...
        for res in pool_results:
            ...
            self.assertAlmostEqual(vector_values[i], results["x"][0], 7, "The initial condition of the state \
            variable x is not %.8f but %.8f" % (results["x"][0], vector_values[i]))
