...
# No drift no dynamics
inputFileName = '../data/SimulationData_CalibrationValve_noDrift.csv'
outputFileName = '../data/NoisyData_CalibrationValve_noDrift.csv'

# Drift no dynamics
#inputFileName = '../data/SimulationData_CalibrationValve_Drift.csv'
#outputFileName = '../data/NoisyData_CalibrationValve_Drift.csv'
